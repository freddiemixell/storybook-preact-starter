...
export const useClasses = ({className = '', backgroundColor = '', textColor = '', backgroundHoverColor = '', backgroundFocusColor = '', bold = false, rounded = false, backgroundOpacity = 100}) => {
	return useCallback(() => {
		let classList = [
			'button',
			'py-2',
	...
	}, [backgroundColor, backgroundHoverColor, backgroundFocusColor, bold, className, rounded, textColor]);
}
